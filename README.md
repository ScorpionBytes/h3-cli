...
To schedule a pentest and optionally assign it a name of you choosing, specify the `op_name` parameter:
...
To retrieve the NodeZero™ Launch Script _URL_ for a scheduled pentest by:
